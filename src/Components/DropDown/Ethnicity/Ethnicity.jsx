...
// STYLES
import { Wrapper } from "./Ethnicity.style";
...
function Ethnicity(props) {
	...
	async function getEthnicity(pagination = paginationInfo) {
		try {
			setLoading(true);
			let response = await new Api().post("ethnicity/list", {
				data: {
			...
			setEthnicity(response.data.rows);
	...
	async function onDelete(id) {
		setLoading(true);
		await new Api().delete("ethnicity/" + id);
		getEthnicity();
	}
	...
	function onTableChange(...rest) {
		...
		getEthnicity(newPaginationInfo);
